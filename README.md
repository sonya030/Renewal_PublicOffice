...
기존의 <span>$\mathrm{\large{\color{#99B463}정적인}}$</span> 사이트의 분위기를 유지하면서 보다 <span>$\bf{\large{\color{#99B463}생동감}}$</span> 있게 리뉴얼 하고자 <span>$\bf{\large{\color{#5D8B22}자연적인,\ 편리한,\ 동양적인,\ 수수한}}$</p> 네가지의 키워드를 선정하여 프로젝트를 진행하였습니다.
